...
train_set="$HOME/data/grpo_chaiting_allpk_new0612_100r_safe_truncted1900_0614_10k_filtered.parquet"
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name='mistral12b_sft_grpo_lora_40k_smo_pk_family_v2_1218' \
